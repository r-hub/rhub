...
platforms at once. E.g. if preparing for a CRAN submission, use the shortcut function
`check_for_cran()` that will submit your package to a few recommended
platforms. The following subsections give more info on how to select a platform.
...
Here's an example where we extract the last group of builds. 
...
your cran-comments.md file (created via e.g. `r usethis::use_cran_comments()`).
